...
class RealTimeWaterLevelAvailabilitySearchPage extends StatefulWidget {
  const RealTimeWaterLevelAvailabilitySearchPage({super.key});

  static const waterLevelAvailabilitySearchPage =
      'RealTimeWaterLevelAvailabilitySearchPage';

  @override
  State<RealTimeWaterLevelAvailabilitySearchPage> createState() =>
      _RealTimeWaterLevelAvailabilitySearchPageState();
}

class _RealTimeWaterLevelAvailabilitySearchPageState
    extends State<RealTimeWaterLevelAvailabilitySearchPage> {
